pfUI:RegisterModule("gui", function ()
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Healthbar Animation Speed", C.unitframes, "animation_speed")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Show Hots of all Classes", C.unitframes, "all_hots", "checkbox")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Show Procs as Buff Indicators", C.unitframes, "show_procs", "checkbox")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Show Procs of all Classes", C.unitframes, "all_procs", "checkbox")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Only Show Indicators for Dispellable Debuffs", C.unitframes, "debuffs_class", "checkbox")

  pfUI.gui:CreateConfig(pfUI.gui.uf, "Clickcast Spells", nil, nil, "header")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Click Action", C.unitframes, "clickcast")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Shift-Click Action", C.unitframes, "clickcast_shift")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Alt-Click Action", C.unitframes, "clickcast_alt")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Ctrl-Click Action", C.unitframes, "clickcast_ctrl")

  pfUI.gui:CreateConfig(pfUI.gui.uf, "Player", nil, nil, "header")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Display Player Frame", C.unitframes.player, "visible", "checkbox")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Buff Size", C.unitframes.player, "buffsize")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Debuff Position", C.unitframes.player, "debuffs", "dropdown", { "top", "bottom", "hide"})
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Debuff Size", C.unitframes.player, "debuffsize")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Invert Health Bar", C.unitframes.player, "invert_healthbar", "checkbox")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Display Target Frame", C.unitframes.target, "visible", "checkbox")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Buff Size", C.unitframes.target, "buffsize")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Debuff Position", C.unitframes.target, "debuffs", "dropdown", { "top", "bottom", "hide"})
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Debuff Size", C.unitframes.target, "debuffsize")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Invert Health Bar", C.unitframes.target, "invert_healthbar", "checkbox")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Portrait Position", C.unitframes.focus, "portrait", "dropdown", { "bar", "left", "right", "off" })
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Health Bar Width", C.unitframes.focus, "width")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Health Bar Height", C.unitframes.focus, "height")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Power Bar Height", C.unitframes.focus, "pheight")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Spacing", C.unitframes.focus, "pspace")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Buff Position", C.unitframes.focus, "buffs", "dropdown", { "top", "bottom", "hide"})
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Buff Size", C.unitframes.focus, "buffsize")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Debuff Position", C.unitframes.focus, "debuffs", "dropdown", { "top", "bottom", "hide"})
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Debuff Size", C.unitframes.focus, "debuffsize")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Invert Health Bar", C.unitframes.focus, "invert_healthbar", "checkbox")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Enable Buff Indicators", C.unitframes.focus, "buff_indicator", "checkbox")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Enable Debuff Indicators", C.unitframes.focus, "debuff_indicator", "checkbox")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Enable Clickcast", C.unitframes.focus, "clickcast", "checkbox")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Enable Range Fading", C.unitframes.focus, "faderange", "checkbox")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Health Bar Width", C.unitframes.group, "width")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Health Bar Height", C.unitframes.group, "height")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Power Bar Height", C.unitframes.group, "pheight")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Spacing", C.unitframes.group, "pspace")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Buff Position", C.unitframes.group, "buffs", "dropdown", { "top", "bottom", "hide"})
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Buff Size", C.unitframes.group, "buffsize")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Debuff Position", C.unitframes.group, "debuffs", "dropdown", { "top", "bottom", "hide"})
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Debuff Size", C.unitframes.group, "debuffsize")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Invert Health Bar", C.unitframes.group, "invert_healthbar", "checkbox")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Portrait Position", C.unitframes.grouptarget, "portrait", "dropdown", { "bar", "left", "right", "off" })
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Health Bar Width", C.unitframes.grouptarget, "width")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Health Bar Height", C.unitframes.grouptarget, "height")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Power Bar Height", C.unitframes.grouptarget, "pheight")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Spacing", C.unitframes.grouptarget, "pspace")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Buff Position", C.unitframes.grouptarget, "buffs", "dropdown", { "top", "bottom", "hide"})
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Buff Size", C.unitframes.grouptarget, "buffsize")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Debuff Position", C.unitframes.grouptarget, "debuffs", "dropdown", { "top", "bottom", "hide"})
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Debuff Size", C.unitframes.grouptarget, "debuffsize")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Invert Health Bar", C.unitframes.grouptarget, "invert_healthbar", "checkbox")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Portrait Position", C.unitframes.grouppet, "portrait", "dropdown", { "bar", "left", "right", "off" })
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Health Bar Width", C.unitframes.grouppet, "width")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Health Bar Height", C.unitframes.grouppet, "height")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Power Bar Height", C.unitframes.grouppet, "pheight")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Spacing", C.unitframes.grouppet, "pspace")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Buff Position", C.unitframes.grouppet, "buffs", "dropdown", { "top", "bottom", "hide"})
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Buff Size", C.unitframes.grouppet, "buffsize")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Debuff Position", C.unitframes.grouppet, "debuffs", "dropdown", { "top", "bottom", "hide"})
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Debuff Size", C.unitframes.grouppet, "debuffsize")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Invert Health Bar", C.unitframes.grouppet, "invert_healthbar", "checkbox")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Portrait Position", C.unitframes.raid, "portrait", "dropdown", { "bar", "left", "right", "off" })
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Health Bar Width", C.unitframes.raid, "width")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Health Bar Height", C.unitframes.raid, "height")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Power Bar Height", C.unitframes.raid, "pheight")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Spacing", C.unitframes.raid, "pspace")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Buff Position", C.unitframes.raid, "buffs", "dropdown", { "top", "bottom", "hide"})
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Buff Size", C.unitframes.raid, "buffsize")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Debuff Position", C.unitframes.raid, "debuffs", "dropdown", { "top", "bottom", "hide"})
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Debuff Size", C.unitframes.raid, "debuffsize")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Portrait Position", C.unitframes.ttarget, "portrait", "dropdown", { "bar", "left", "right", "off" })
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Health Bar Width", C.unitframes.ttarget, "width")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Health Bar Height", C.unitframes.ttarget, "height")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Power Bar Height", C.unitframes.ttarget, "pheight")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Spacing", C.unitframes.ttarget, "pspace")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Buff Position", C.unitframes.ttarget, "buffs", "dropdown", { "top", "bottom", "hide"})
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Buff Size", C.unitframes.ttarget, "buffsize")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Debuff Position", C.unitframes.ttarget, "debuffs", "dropdown", { "top", "bottom", "hide"})
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Debuff Size", C.unitframes.ttarget, "debuffsize")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Invert Health Bar", C.unitframes.ttarget, "invert_healthbar", "checkbox")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Enable Buff Indicators", C.unitframes.target, "buff_indicator", "checkbox")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Enable Debuff Indicators", C.unitframes.target, "debuff_indicator", "checkbox")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Enable Clickcast", C.unitframes.target, "clickcast", "checkbox")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Enable Range Fading", C.unitframes.target, "faderange", "checkbox")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Portrait Position", C.unitframes.pet, "portrait", "dropdown", { "bar", "left", "right", "off" })
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Health Bar Width", C.unitframes.pet, "width")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Health Bar Height", C.unitframes.pet, "height")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Power Bar Height", C.unitframes.pet, "pheight")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Spacing", C.unitframes.pet, "pspace")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Buff Position", C.unitframes.pet, "buffs", "dropdown", { "top", "bottom", "hide"})
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Buff Size", C.unitframes.pet, "buffsize")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Debuff Position", C.unitframes.pet, "debuffs", "dropdown", { "top", "bottom", "hide"})
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Debuff Size", C.unitframes.pet, "debuffsize")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Invert Health Bar", C.unitframes.pet, "invert_healthbar", "checkbox")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Portrait Position", C.unitframes.fallback, "portrait", "dropdown", { "bar", "left", "right", "off" })
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Health Bar Width", C.unitframes.fallback, "width")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Health Bar Height", C.unitframes.fallback, "height")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Power Bar Height", C.unitframes.fallback, "pheight")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Spacing", C.unitframes.fallback, "pspace")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Buff Position", C.unitframes.fallback, "buffs", "dropdown", { "top", "bottom", "hide"})
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Buff Size", C.unitframes.fallback, "buffsize")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Debuff Position", C.unitframes.fallback, "debuffs", "dropdown", { "top", "bottom", "hide"})
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Debuff Size", C.unitframes.fallback, "debuffsize")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Invert Health Bar", C.unitframes.fallback, "invert_healthbar", "checkbox")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Enable Buff Indicators", C.unitframes.fallback, "buff_indicator", "checkbox")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Enable Debuff Indicators", C.unitframes.fallback, "debuff_indicator", "checkbox")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Enable Clickcast", C.unitframes.fallback, "clickcast", "checkbox")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Enable Range Fading", C.unitframes.fallback, "faderange", "checkbox")
