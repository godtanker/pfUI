pfUI:RegisterModule("gui", function ()
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Show Hots on Buff Indicators", C.unitframes, "show_hots", "checkbox")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Show Hots of all Classes", C.unitframes, "all_hots", "checkbox")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Show Procs on Buff Indicators", C.unitframes, "show_procs", "checkbox")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Clickcast", nil, nil, "header")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Clickcast", C.unitframes, "clickcast")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Clickcast (Shift)", C.unitframes, "clickcast_shift")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Clickcast (Alt)", C.unitframes, "clickcast_alt")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Clickcast (Ctrl)", C.unitframes, "clickcast_ctrl")
