...
--  pfUI:UpdateConfig("unitframes", nil,           "debuff_size",      "20")  -- TODO migrate, deprecated
  ...
  pfUI:UpdateConfig("unitframes", "focus",       "width",            "200")
  pfUI:UpdateConfig("unitframes", "focus",       "height",           "50")
  pfUI:UpdateConfig("unitframes", "focus",       "pheight",          "10")
  pfUI:UpdateConfig("unitframes", "focus",       "pspace",           "-3")
  pfUI:UpdateConfig("unitframes", "focus",       "buffs",            "top")
  pfUI:UpdateConfig("unitframes", "focus",       "buffsize",         "20")
  pfUI:UpdateConfig("unitframes", "focus",       "debuffs",          "top")
  pfUI:UpdateConfig("unitframes", "focus",       "debuffsize",       "20")
