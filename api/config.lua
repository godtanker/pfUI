...
function pfUI:LoadConfig()
  ...
  pfUI:UpdateConfig("unitframes", nil,           "buff_size",        "20")  -- TODO deprecated
  pfUI:UpdateConfig("unitframes", nil,           "debuff_size",      "20")  -- TODO deprecated
  ...
  pfUI:UpdateConfig("unitframes", "player",      "txtleft",          "power")
  ...
  pfUI:UpdateConfig("unitframes", "target",      "txtleft",          "power")
  pfUI:UpdateConfig("unitframes", "target",      "txtcenter",        "healthmiss")
  pfUI:UpdateConfig("unitframes", "target",      "txtright",         "healthmiss")
  ...
  pfUI:UpdateConfig("unitframes", "group",       "buffsize",         "16")
  pfUI:UpdateConfig("unitframes", "group",       "debuffs",          "bottom")
  pfUI:UpdateConfig("unitframes", "group",       "debuffsize",       "16")
  pfUI:UpdateConfig("unitframes", "group",      "txtleft",          "powerperc")
  pfUI:UpdateConfig("unitframes", "group",      "txtcenter",        "healthmiss")
  ...
  pfUI:UpdateConfig("unitframes", "grouptarget",       "width",            "100")
  pfUI:UpdateConfig("unitframes", "grouptarget",       "height",           "18")
  pfUI:UpdateConfig("unitframes", "grouptarget",       "pheight",          "4")
  ...
  pfUI:UpdateConfig("unitframes", "grouptarget",      "txtleft",          "powerperc")
  pfUI:UpdateConfig("unitframes", "grouptarget",      "txtcenter",        "healthmiss")
  pfUI:UpdateConfig("unitframes", "grouptarget",      "txtright",         "healthmiss")
  ...
  pfUI:UpdateConfig("unitframes", "raid",      "txtleft",          "powerperc")
  pfUI:UpdateConfig("unitframes", "raid",      "txtcenter",        "healthmiss")
  ...
  pfUI:UpdateConfig("unitframes", "ttarget",      "txtleft",          "powerperc")
  pfUI:UpdateConfig("unitframes", "ttarget",      "txtcenter",        "healthmiss")
  pfUI:UpdateConfig("unitframes", "ttarget",      "txtright",         "healthmiss")
  ...
  pfUI:UpdateConfig("unitframes", "pet",      "txtleft",          "powerperc")
  pfUI:UpdateConfig("unitframes", "pet",      "txtcenter",        "healthmiss")
  pfUI:UpdateConfig("unitframes", "pet",      "txtright",         "healthmiss")
